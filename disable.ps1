        ...
        'DisableAccount' {
            foreach ($accessKey in $accessKeyList) {
                ...
                if (-not($actionContext.DryRun -eq $true)) {
                    Write-Information "Disabling IProtect AccessKey with AccessKeyId: [$($accessKey.AccessKeyId)] RCN: [$($accessKey.RCN)]"
                    ...
                    Write-Information "[DryRun] Disable IProtect accessKey with AccessKeyId: [$($accessKey.AccessKeyId)] RCN: [$($accessKey.RCN)], will be executed during enforcement"
                }

                $outputContext.AuditLogs.Add([PSCustomObject]@{
                        Message = "AccessKey with AccessKeyId: [$($accessKey.AccessKeyId)] RCN: [$($accessKey.RCN)] was successfully disabled"
                        IsError = $false
                    })
            }
